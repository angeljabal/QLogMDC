                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <h1 class="ml-3 text-2xl font-bold leading-7 text-gray-900 sm:leading-9 sm:truncate">
                            Good morning, Christine May Jabal
                        </h1>
                    </div>
                    <dl class="mt-6 flex flex-col sm:ml-3 sm:mt-1 sm:flex-row sm:flex-wrap">
                        ...
                        <dd class="mt-3 flex items-center text-sm text-gray-500 font-mvg class="flex-shrink-0 mr-1.5 h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4 text-right whitespace-nowrap text-sm text-gray-500">
                                <span class="text-gray-900 font-medium">02:00 pm</span>
                            </td>
