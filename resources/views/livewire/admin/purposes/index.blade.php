<div>
        ...
        <div class="sm:block">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8  m-5">
                <div class="relative w-full max-w-full mb-5">
                    <h3 class="font-semibold text-2xl text-gray-900">List of Purposes</h3>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($purposes as $purpose)
                                    <tr class="bg-white">
                                        <td class="max-w-0 w-full px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-left">
    ...
    <x-modals.confirmation wire:model="confirmingPurposeDeletion">
        ...
        <x-slot name="footer">
            ...
            <button class="px-4 py-2 text-sm rounded-md bg-red-500 text-white hover:bg-red-700" wire:click="deletePurpose()" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </button>
        </x-slot>
