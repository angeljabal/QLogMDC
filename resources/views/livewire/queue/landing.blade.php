<div>
    ...
    @if (Auth::check())
      <div>
          <livewire:queue.process :userId="$userId" :wire:key="'user-'.$userId">
      </div>
    @else
        ...
        <div class="md:max-w-full md:mx-auto">
          <div class="md:ml-10 md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
                ...
                <input type='text' wire:model.lazy="userId" onblur="this.focus();" id="link_input" autofocus class="bg-cyan-800 focus:outline-none text-cyan-800" autocomplete="off"/>
                </form>
            </div>
